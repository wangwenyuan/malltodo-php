...
<?php
if (TD_CONTROLLER_NAME == "Index") {
    require_once __DIR__ . "/home/index_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Custom") {
    require_once __DIR__ . "/home/index_custom_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Bottom") {
    require_once __DIR__ . "/home/bottom_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Header") {
    require_once __DIR__ . "/home/header_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Menu") {
    require_once __DIR__ . "/home/menu_nav.php";
} else if (TD_CONTROLLER_NAME == "News") {
    require_once __DIR__ . "/home/index_news_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "NewsDetail") {
    require_once __DIR__ . "/home/index_news_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Product") {
    require_once __DIR__ . "/home/index_products_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "ProductDetail") {
    require_once __DIR__ . "/home/index_products_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Brief") {
    require_once __DIR__ . "/home/index_brief_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "BriefDetail") {
    require_once __DIR__ . "/home/index_brief_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Business") {
    require_once __DIR__ . "/home/index_business_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "BusinessDetail") {
    require_once __DIR__ . "/home/index_business_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Case") {
    require_once __DIR__ . "/home/index_case_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "CaseDetail") {
    require_once __DIR__ . "/home/index_case_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Album") {
    require_once __DIR__ . "/home/index_album_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "AlbumDetail") {
    require_once __DIR__ . "/home/index_album_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Job") {
    require_once __DIR__ . "/home/index_job_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "JobDetail") {
    require_once __DIR__ . "/home/index_job_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "ContactUs") {
    require_once __DIR__ . "/home/index_contactus_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "ContactUsDetail") {
    require_once __DIR__ . "/home/index_contactus_detail_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Search") {
    require_once __DIR__ . "/home/index_search_list_nav_pc.php";
} else if (TD_CONTROLLER_NAME == "Message") {
    require_once __DIR__ . "/home/index_message_list_nav_pc.php";
}
?>
						<div class="clear"></div>
...
function get_widget(widget_category, widget_name, widget_sign, widget_json){
	...
	var url = "<?=TDU(TD_MODULE_NAME . "/ShowWidget/create")?>"+"&category="+widget_category+"&name="+widget_name;
