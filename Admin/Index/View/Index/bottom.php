...
$('.zuo_li').click(function(){
	...
	$(this).css({'background':'url(<?=TD_URL?>/Public/images/arrow.png)','color':'#333'});
...
$('.<?=TD_MODULE_NAME?>_<?=TD_CONTROLLER_NAME?>').parent().children('.zuo_tou').click();
$('.<?=TD_MODULE_NAME?>_<?=TD_CONTROLLER_NAME?>').css({'background':'url(<?=TD_URL?>/Public/images/arrow.png)','color':'rgb(51,51,51)'}).addClass('zuo_li_dianji');
